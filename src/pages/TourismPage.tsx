...
export function TourismPage() {
  ...
  return (
    <main className="tourism-page">
      ...
      <section className="tourism-visit" aria-labelledby="visit-title"><div className="tourism-shell tourism-visit__inner"><div className="tourism-visit__intro"><p className="tourism-eyebrow">Визит без неопределённости</p><h2 id="visit-title">До. Во время. После.</h2><Reveal className="tourism-visit__media" delay={0.08}><img src="/images/family-dent-2-reception.jpg" width="4000" height="6000" loading="lazy" alt="Зона ожидания Family Dent 2 в Душанбе" /></Reveal></div><div className="tourism-visit__steps"><Reveal><span>До визита</span><p>Собираем доступные снимки и уточняем медицинскую задачу.</p></Reveal><Reveal delay={0.07}><span>В Душанбе</span><p>Проводим очную диагностику и согласуем дальнейшие действия.</p></Reveal><Reveal delay={0.14}><span>После визита</span><p>Остаёмся на связи по вопросам согласованного лечения.</p></Reveal></div></div></section>
