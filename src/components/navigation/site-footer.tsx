      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-xs text-paper/60 font-light leading-relaxed">
              Современная семейная стоматология в Душанбе. Цифровая диагностика, лечение под микроскопом и персональная забота о каждом пациенте.
            </p>
          </div>

          {/* Col 2: Navigation */}
          <div className="flex flex-col gap-2">
            <h4 className="text-xs uppercase font-semibold text-accent tracking-wider mb-2 font-mono">
              Разделы сайта
            </h4>
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="flex items-start gap-2 text-xs text-paper/80">
            ...
            <a href="tel:+992446606600" className="flex items-center gap-2 text-xs text-paper/80 hover:text-accent-2">
        ...
        <div className="pt-6 border-t border-rule/20 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-paper/40">
          <span>© {new Date().getFullYear()} Family Dent. Все права защищены.</span>
          <div className="flex items-center gap-4">
            <span className="hover:text-paper/60 transition-colors">Политика конфиденциальности</span>
            <span>•</span>
            <span className="hover:text-paper/60 transition-colors">Лицензия №12834-ТМ</span>
          </div>
        </div>
      </div>
    </footer>
