...
export function BackgroundVideo() {
  return (
    <div className="absolute inset-0 z-0 h-full w-full pointer-events-none select-none overflow-hidden">
      ...
      <div
        className="absolute top-1/2 left-1/2 h-[700px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full blur-[120px] pointer-events-none sm:h-[900px] sm:w-[900px] animate-green-pulse"
